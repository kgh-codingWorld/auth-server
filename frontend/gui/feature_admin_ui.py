import gradio as gr
from ..utils.feature_admin_util import add_feature

def feature_admin_ui(token_output):
    with gr.Blocks() as feature_admin_demo:
        gr.Markdown("## 기능 관리")
        user_id_input = gr.Textbox(label="관리자 ID")
        ...
        feature_add_btn.click(add_feature, inputs=[token_output, feature_name_input, feature_description_input, user_id_input], outputs=feature_add_status)
